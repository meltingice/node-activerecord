(function() {
  ...
  exports.Model = Model = (function() {
    ...
    Model.prototype.save = function(cb) {
      ...
      primaryIndex = this._initData[this.primaryIndex];
      _ref = this.adapters;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        adapter = _ref[_i];
        ...
        _results.push(adapter.write(primaryIndex, this.tableName(), this._dirtyData, this.isNew(), {
          ...
          _this._initData[_this.primaryIndex] = results.lastID;
          if (_this.isNew()) {
