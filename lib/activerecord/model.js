(function() {
  ...
  exports.Model = Model = (function() {
    ...
    Model.prototype.save = function(cb) {
      ...
      if (this.isNew() && (this.idMiddleware != null)) {
        middleware = require("" + __dirname + "/middleware/" + this.idMiddleware);
        mConfig = this.config.get('middleware');
        if (mConfig != null ? mConfig[this.idMiddleware] : void 0) {
          mOpts = mConfig[this.idMiddleware];
        } else {
          mOpts = {};
        }
      ...
      if (this.isNew() && (this.idMiddleware != null) && middleware.supports.beforeWrite) {
        return m.beforeWrite(this.idMiddlewareOptions, preID);
      } else {
    ...
    Model.prototype._afterSave = function() {
      return true;
    };
